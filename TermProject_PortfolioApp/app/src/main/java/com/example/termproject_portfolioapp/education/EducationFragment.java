...
import com.example.termproject_portfolioapp.cv.CVAdapter;
...
public class EducationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RvEducation = view.findViewById(R.id.recyclerview_education);



        items = new ArrayList<>();
        items.add(new CVItem("2018 – 2022","Yasar University / Software Engineering"));
        items.add(new CVItem("2015-2017","Ege University / Computer programming"));
        items.add(new CVItem("2010-2014","Karşıyaka Gazi Anatolian High School"));
